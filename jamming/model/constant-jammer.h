...
public:
  ...
  void SetJammingReactMethod(JammingReactMethod method);
  uint32_t GetJammingReactMethod (void) const;
...
private:
  ...
  virtual void Optimal(uint32_t optimal);
  ...
  uint32_t GetObservationsRl(void);
...
private:
  ...
  Ptr<MyGymEnvJammer> m_myGymEnv; //Pointer to GymEnv
  JammingReactMethod m_jammingReactMethod; 
  bool m_jamming;
  uint32_t m_channelOptimal;
