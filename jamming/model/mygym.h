...
namespace ns3 {
    ...
    class MyGymEnv : public OpenGymEnv
    {
        public:
            MyGymEnv();
            MyGymEnv(uint32_t currentChannel, uint32_t channelNum);
            virtual ~MyGymEnv ();
            ...
            static void PerformCca(Ptr<MyGymEnv> entity,uint16_t channelId,  double avgPowerSpectralDensity);
            static void PerformJamming(Ptr<MyGymEnv> entity,uint16_t channelId,  double avgPowerSpectralDensity);
